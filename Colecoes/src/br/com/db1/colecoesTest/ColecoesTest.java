package br.com.db1.colecoesTest;
...
public class ColecoesTest{
	private ExemploColecao colecao;
	...
	/*
	 * @Test public void arrayTest() { ExemploArray exemplo = new
	 * ExemploArray(); String[] nome = exemplo.getNomes(); }
	...
	public void exercicio2Test(){
		colecao.removerNomes("Mateus");
		colecao.removerNomes("Luiz");
		colecao.removerNomes("Matheus");
		Assert.assertTrue(8 == colecao.tamanhoLista());
	}
	@Test
	public void fuscaNaLista(){
		Assert.assertFalse(colecao.estaNaLista("Fusca"));
	}
	@Test
	public void leonardoNaLista(){
